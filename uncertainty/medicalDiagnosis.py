...
if __name__ == '__main__':
    ...
    # lis.append(b)
    # c = VE(medical, ac, [bmi,co,hl])
    # lis.append(c)
    # d = VE(medical, ac, [bmi,hl,gd,co])
    # lis.append(d)
    # e = VE(medical, ac, [bmi,hl,gd,co,ag])
    # lis.append(e)
    #
    # for i in range(6):
    #     print(lis[i][0])
    ...
    # co.set_evidence('YES')
    # ht.set_evidence('NO')
    # vg.set_evidence('>500g/d')
    # lis = []
    # a = VE(medical, hl, [ht])
    # lis.append(a)
    # b = VE(medical, hl, [gd,ht])
    # lis.append(b)
    # c = VE(medical, hl, [gd,ag,ht])
    # lis.append(c)
    # d = VE(medical, hl, [gd,ag,ht,co])
    # lis.append(d)
    # e = VE(medical, hl, [gd,ag,ht,co,bmi])
    # lis.append(e)
    ...
    lis = []
    a = VE(medical, ag, [hl, ht])
    lis.append(a)
    b = VE(medical, ag, [gd, hl, ht])
    lis.append(b)
    c = VE(medical, ag, [hl, ht, ac])
    lis.append(c)
    d = VE(medical, ag, [hl, ht, ac, gd])
    lis.append(d)
